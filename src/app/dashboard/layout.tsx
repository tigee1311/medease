  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,_#f4efe7_0%,_#f7f4ef_35%,_#efe7db_100%)] text-stone-900">
      <div className="mx-auto flex max-w-7xl flex-col gap-6 px-4 py-4 sm:px-6 lg:flex-row lg:px-8">
        <aside className="lg:sticky lg:top-4 lg:h-[calc(100vh-2rem)] lg:w-80">
          <div className="flex h-full flex-col rounded-[2rem] border border-stone-200/80 bg-[linear-gradient(180deg,_rgba(255,255,255,0.96),_rgba(248,243,236,0.98))] p-6 shadow-[0_18px_60px_rgba(87,68,48,0.12)]">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.24em] text-amber-700">MedEase</p>
              <h1 className="mt-3 text-3xl font-semibold tracking-tight">Daily medication clarity</h1>
            ...
            <div className="mt-8 rounded-[1.75rem] bg-stone-900 p-5 text-stone-50">
              ...
              <p className="mt-1 text-sm text-stone-300">{user.role === "SENIOR" ? "Senior account" : "Caregiver account"}</p>
              <div className="mt-4 rounded-2xl bg-white/10 p-4 text-sm leading-6 text-stone-200">
